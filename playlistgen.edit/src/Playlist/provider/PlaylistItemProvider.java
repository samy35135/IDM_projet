		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Playlist_video_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Playlist_video_feature", "_UI_Playlist_type"),
				 PlaylistPackage.Literals.PLAYLIST__VIDEO,
				 true,
				 false,
				 true,
				 null,
