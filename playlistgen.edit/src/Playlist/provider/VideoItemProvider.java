...
public class VideoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlaylistPackage.Literals.VIDEO__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addCheminPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Video_chemin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Video_chemin_feature", "_UI_Video_type"),
				 PlaylistPackage.Literals.VIDEO__CHEMIN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Video_type") + " " + video.getDuree();
	}
