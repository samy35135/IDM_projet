...
public class VideogenStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.VideogenRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/Videogen")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/Videogen", org.xtext.videogen.VideogenPackage.eINSTANCE);
	}
