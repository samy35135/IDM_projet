...
public class PlaylistPackageImpl extends EPackageImpl implements PlaylistPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVideo_Duree(), ecorePackage.getEInt(), "duree", null, 0, 1, Video.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
